...
# Sys.setenv(TZ='America/New_York') # Change to same timezone as Yellowbrick
...
# load Data
# load(file.path(app_dir, "data/raw/data_demo.RData"))

# load all modules
# source("modules/brandAffinityPage.R")
# source("modules/timeAffinityPage.R")
# source("modules/storePersonalitiesPage.R")
# source("modules/cameoPage.R")
source("modules/toolPage.R")
source("modules/tourPage.R")
